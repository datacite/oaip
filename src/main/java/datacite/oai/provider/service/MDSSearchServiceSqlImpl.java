 ...
 *
 */
public class MDSSearchServiceSqlImpl extends MDSSearchService {

    private static final Logger logger = Logger.getLogger(MDSSearchServiceSqlImpl.class);    
     ...
     */
    public MDSSearchServiceSqlImpl(ServletContext servletContext) throws ServiceException {

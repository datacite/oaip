...
public class GetRecord extends ServerVerb {
    private static final Logger log = Logger.getLogger(GetRecord.class);    
    ...
    if (baseURL == null) {
        ...
        if (debug) {
            log.info("GetRecord.constructGetRecord: identifier=" +
                               identifier);
            log.info("GetRecord.constructGetRecord: metadataPrefix="
                               + metadataPrefix);
        }

...
public class CannotDisseminateFormatException extends Exception {
    ...
    private static final Logger logger = Logger.getLogger(CannotDisseminateFormatException.class);
    ...
    public CannotDisseminateFormatException(String metadataPrefix) {        
        ...
        logger.error(metadataPrefix + " is not supported by the item or by the repository", this);      
    }
}

...
<p>You can use custom solr search queries in your set name. Therefor the solr query string must be base64url encoded, see <a href="https://tools.ietf.org/html/rfc4648#page-7">RFC 4648</a>, and appended to any normal setname or the empty string seperated by a quotation mark.</p>
<p>Example:</p>
<table>

...
+"</xsl:stylesheet>\n";
        try {
            if (debug) {
                log.info("Redirect.<init>: xsltString=" + xsltString);
            }
    ...
    if (baseURL == null) {
        ...
        if (debug) {
            log.info("Redirect.construct: identifier=" +
                               identifier);
        }
    ...
    try {
        ...
        throw new BadArgumentException();
                ...
                if (debug) log.info("crosswalk not present: oai_dc");
        ...
        if (debug) {
            log.info("Redirect.construct: prerendered sb=" + sb.toString());
        }
        if (debug) {
            log.info("Redirect.construct: transformer=" + transformer);
        }
        synchronized (transformer) {
            ...
            if (debug) {
                log.info("Redirect.construct: out=" + out);
            }
            return out;
        }
    }

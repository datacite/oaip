...
public class NodeRecordFactory extends RecordFactory {
     private static Logger log = Logger.getLogger(NodeRecordFactory.class);
//     static {
...
//                 "http://www.loc.gov/MARC21/slim");
    ...
    try {
        ...
        log.info("sruURL=" + sruURL);
        Document explainDoc = parser.parse(sruURL);
        log.info("explainDoc=" + explainDoc);
...
//      logger.warn("Problem obtaining namespace", e);
        log.info("Failed to get schema: " + schema);
        e.printStackTrace();
        metadataNamespace = "";
    }

...
//  super("http://www.openarchives.org/OAI/2.0/oai_dc/ http://www.openarchives.org/OAI/2.0/oai_dc.xsd");
    ...
    public String createMetadata(Object nativeItem) throws CannotDisseminateFormatException {
        try {
            ...
            if (debug) {
                log.info("XSLTCrosswalk.createMetadata: xmlRec=" + xmlRec);
            }
            ...
            if (debug) {
                log.info("XSLTCrosswalk.createMetadata: transformer=" + transformer);
            }
            if (transformer != null) {
                ...
                if (debug) {
                    log.info("XSLTCrosswalk.createMetadata: return=" + stringWriter.toString());
                }
